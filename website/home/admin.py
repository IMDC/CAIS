...
from .models import Question, Category, Response, AnswerText, AnswerRadio, AnswerVideo, Blobby, VideoGenerator, CaptionName
...
class BlobbyInline(admin.StackedInline):
	...
	readonly_fields = ('_data_one', '_data_two',)
	extra = 0
...
class ResponseAdmin(admin.ModelAdmin):
	...
	inlines = [AnswerTextInline, AnswerRadioInline, AnswerVideoInline, BlobbyInline, CaptionNameInline]
